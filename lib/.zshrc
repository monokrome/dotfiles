...
plugins=(git gitfast git-remote-branch osx node heroku github brew django gem npm pip python vi-mode battery bwana history-substring-search lol mercurial osx sprunge sublime ssh-agent svn systemd themes vagrant urltools wakeonlan zsh-vim-mode)
