...
plugins=(git gitfast git-remote-branch osx node heroku github golang brew django gem npm pip python vi-mode battery history-substring-search lol mercurial osx sprunge sublime svn systemd themes vagrant urltools wakeonlan zsh-vim-mode knife)
